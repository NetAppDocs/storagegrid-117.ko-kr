...
을 참조하십시오 https://["NetApp 상호 운용성 매트릭스 툴"^] (IMT) 을 클릭하여 사용해야 하는 StorageGRID 소프트웨어 버전을 확인합니다. 핫픽스가 필요한 경우 NetApp은 가장 최근 릴리즈에 대한 업데이트를 만드는 데 우선 순위를 지정합니다. 일부 패치는 이전 릴리스와 호환되지 않을 수 있습니다.

* 최신 StorageGRID 릴리스 및 핫픽스를 다운로드하려면 로 이동하십시오 https://["NetApp 다운로드: StorageGRID"^].
