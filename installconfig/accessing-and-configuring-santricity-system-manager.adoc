...
---
= SANtricity 시스템 관리자 구성(SG6000 및 SG5700)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
관리 포트를 사용하지 않고 E-Series AutoSupport 메시지를 보내기 위해 StorageGRID 프록시를 구성하는 방법에 대한 자세한 내용은 로 이동하십시오 link:../admin/configuring-storage-proxy-settings.html["스토리지 프록시 설정 구성 지침"].
