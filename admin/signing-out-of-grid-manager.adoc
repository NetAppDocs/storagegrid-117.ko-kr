...
* 참고: * SSO가 활성화되어 있고 테넌트 관리자에도 로그인한 경우, 반드시 로그인 해야 합니다 link:../tenant/signing-out-of-tenant-manager.html["테넌트 계정에서 로그아웃합니다"] 를 선택합니다 link:configuring-sso.html["SSO에서 로그아웃합니다"].
