...
NOTE: 이 지침에서 "'Linux'는 Red Hat ® Enterprise Linux ®, Ubuntu ®, CentOS 또는 Debian ® 배포를 의미합니다. 를 사용합니다 https://imt.netapp.com/matrix/#welcome["NetApp 상호 운용성 매트릭스 툴"^] 를 클릭하여 지원되는 버전 목록을 가져옵니다.
...
하드웨어 절차는 StorageGRID 어플라이언스에 대한 유지 관리 지침을 참조하십시오.
